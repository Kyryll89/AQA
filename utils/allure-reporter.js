...
class AllureReporter {
  ...
  getImplementation() {
    return new jest_allure_interface_1.default(
      this,
      this.allureRuntime,
      this.jiraUrl
    );
  ...
  startSuite(suiteName) {
    var _a;
    const scope =
      (_a = this.currentSuite) !== null && _a !== void 0
        ? _a
        : this.allureRuntime;
    const suite = scope.startGroup(
      suiteName !== null && suiteName !== void 0 ? suiteName : "Global"
    );
  ...
  startTestCase(test, state, testPath) {
    ...
    currentTest.historyId = crypto_1
      .createHash("md5")
    ...
    if (
      (_b =
        (_a = state.parentProcess) === null || _a === void 0
          ? void 0
      ...
      currentTest.addLabel(
        allure_js_commons_1.LabelName.THREAD,
        state.parentProcess.env.JEST_WORKER_ID
      );
    }
    currentTest = this.addSuiteLabelsToTestCase(
      currentTest,
      this.collectTestParentNames(test.parent)
    );
  ...
  failTestCase(error) {
    ...
    const isBrokenTest =
      latestStatus === allure_js_commons_1.Status.BROKEN &&
    ...
    // this.currentTest.statusDetails = { message:  `${message}\n\n${trace}` };
    ...
    if (!message && trace) {
      ...
      trace =
        (_a = error.stack) === null || _a === void 0
          ? void 0
          : _a.replace(message, "No stack trace provided");
    }
    if (trace === null || trace === void 0 ? void 0 : trace.includes(message)) {
      trace =
        trace === null || trace === void 0
          ? void 0
          : trace.replace(message, "");
    }
    if (!message) {
    ...
    switch (labelName) {
      case "issue":
        currentTest.addLink(
          `${this.jiraUrl}${value}`,
          value,
          allure_js_commons_1.LinkType.ISSUE
        );
        break;
      case "tms":
        currentTest.addLink(
          `${this.tmsUrl}${value}`,
          value,
          allure_js_commons_1.LinkType.TMS
        );
        break;
      case "tag":
      case "tags":
  ...
  addSuiteLabelsToTestCase(currentTest, testPath) {
    if (testPath[1]) {
      currentTest.addLabel(
        allure_js_commons_1.LabelName.PARENT_SUITE,
        testPath[1]
      );
      currentTest.addLabel(allure_js_commons_1.LabelName.PACKAGE, testPath[1]);
    }
    return currentTest;
  }
  ...
  collectTestParentNames(parent) {
    ...
    do {
      testPath.unshift(
        parent === null || parent === void 0 ? void 0 : parent.name
      );
    } while (
